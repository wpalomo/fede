 ...
 * @author jlgranda
 */
public class LazyBalancedScoreCardDataModel extends LazyDataModel<BalancedScoreCard> implements Serializable {
     private static final int MAX_RESULTS = 5;
    Logger  logger = LoggerFactory.getLogger(LazyFacturaElectronicaDataModel.class);

    private BalancedScoreCardService bussinesEntityService;
    ...
    public LazyBalancedScoreCardDataModel(BalancedScoreCardService bussinesEntityService) {
